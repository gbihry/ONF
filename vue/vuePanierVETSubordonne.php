<div class="container-fluid text-center">
    ...
    <div class="panier">
            ...
            echo ("<div class='content'>
                    ...
                    echo ("
                        ...
                        <div class='quantite' 'data-idligne='" . $idLigne . "'>
                            ...
                            <div id='quantite' data-ligne='". $idLigne ."' data-iduser='".$_GET['id']."' data-data='". $quantite . "'><span>" . $quantite . "</span><div class='clear'></div><a class='edit_btn' onclick='edit(this,\"quantiteVETSub\")' name='edit_btn'><i class='fa-solid fa-pencil'></i> Modifier</a></div>
                        </div>
                        <div class='taille'>
                        ...
                        ");
                            ...
                            if ($taille == "Taille Unique"){
                                ...
                                echo ("<div id='quantite' data-iduser='".$_GET['id']."' data-produit='". $idProduit ."' data-ligne='". $idLigne ."' data-taille='". $idTaille ."' data-data='". $taille . "'><span>" . $taille . "</span><div class='clear'></div><a class='edit_btn' onclick='edit(this,\"tailleVETSub\")' name='edit_btn'><i class='fa-solid fa-pencil'></i> Modifier</a></div>");
                            }
                        ?>
                        </div>
                        <div class='supprimer'>
        ...
        <?php
                ...
                echo('
                <form action="./?action=recapPanierSubordonne&type=vet&ref='.$_GET['id'].'" method="POST">
